<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5  dark:bg-gray-800 border">
    ...
    <a href="#" class="flex">
      {{-- <svg class="mr-3 h-10" ></svg> --}}
      <img src="/img/logo.png" alt="" class="mr-3 h-10">
    ...
    <div class="flex md:order-2">
      ...
      <div id="dropdown" class="hidden z-10 w-44 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
          <ul class="py-1" aria-labelledby="dropdownButton">
            ...
            <li>
              <a href="/teacher" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Teacher</a>
            </li>
            <li>
    ...
    <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-4">
      <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
        ...
        <li>
          <a href="/agreements" class="block py-2 pr-4 pl-3 {{ (request()->is('agreements*')) ? 'bg-blue-700 md:bg-transparent md:text-blue-700 rounded text-white' : 'md:text-gray-700 sm:text-gray-700 sm:border-gray-100 hover:bg-gray-50 md:border-0 md:hover:bg-transparent' }}  md:p-0 dark:text-white" aria-current="page">Agreements</a>
        </li>
        <li>
