                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12 mb-2">
                                <input type="text" class="form-control bg-white" value="{{ $loan->bucket->book->title }}" disabled>
                            </div>
                            <div class="col-md-6">
                                <img src="/storage/{{ $loan->bucket->book->image }}" alt="" style="width: 100%;">
                            </div>
                            <div class="col-md-6">
                                <label for="">Creator</label>
                                <input type="text" class="form-control bg-white" value="{{ $loan->bucket->book->creator }}" disabled>
                                <label for="">Penerbit Lokal</label>
                                <input type="text" class="form-control bg-white" value="{{ $loan->bucket->book->local_publisher }}" disabled>
                                <label for="">Penerbit</label>
                                <input type="text" class="form-control bg-white" value="{{ $loan->bucket->book->original_publisher }}" disabled>
                                <label for="">Kode rak</label>
                                <input type="text" class="form-control bg-white" value="{{ $loan->bucket->book->bookcase->name }}" disabled>
                                <label for="">Nomor Rak</label>
                                <input type="text" class="form-control bg-white" value="{{ $loan->bucket->book->bookcase->location_bookcase }}" disabled>
                                <label for="">Stok</label>
                                <input type="text" class="form-control bg-white" value="{{ $loan->bucket->book->stock }}" disabled>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card shadow" style="width:100%">
                    <div class="card-body">
                        ...
                        <input type="text" id="admin" disabled value="{{ $loan->bucket->book->admin->name }}" class="form-control bg-white">
