        ...
        <div class="xl:grid md:grid lg:grid sm:grid xl:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 sm:grid-cols-12 xl:gap-4 lg:gap-4 md:gap-y-4 sm:gap-y-4 gap-y-4">
                ...
                <div class="block p-3 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" style="width: 100%;">
                    ...
                    <div class="grid grid-cols-12 mt-2 gap-x-4">
                        <div class="col-span-12 mb-2">
                            <input type="text" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full" value="{{ $loan->book->title }}" disabled>
                        </div>
                        <div class="col-span-6">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="text" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full" value="{{ $loan->book->creator }}" disabled>
                            ...
                            <input type="text" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full" value="{{ $loan->book->local_publisher }}" disabled>
                            ...
                            <input type="text" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full" value="{{ $loan->book->original_publisher }}" disabled>
                            ...
                            <input type="text" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full" value="{{ $loan->book->bookcase->name }}" disabled>
                            ...
                            <input type="text" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full" value="{{ $loan->book->bookcase->location_bookcase }}" disabled>
                            <label for="" class="p-0 m-0 block text-sm xl:text-lg md:text-base font-medium text-gray-900 dark:text-gray-300">Stok</label>
                            <input type="text" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full" value="{{ $loan->book->stock }}" disabled>
                        </div>
                    </div>
                </div>
            </div>
            <div class="xl:col-span-6 md:col-span-12 lg:col-span-6 sm:col-span-12">
                <div class="block p-3 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" style="width:100%">
                        ...
                        <input type="text" id="totalDenda" disabled value="{{ $loan->forfeit }}" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full">
                        ...
                        <input type="text" id="admin" disabled value="{{ $loan->book->admin->name }}" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full">
                        ...
                        <input type="text" id="status" disabled value="{{ $loan->status }}" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full">
                        <label for="type" class="p-0 m-0 block text-sm xl:text-lg md:text-base font-medium text-gray-900 dark:text-gray-300">Type pembayaran</label>
                        <input type="text" id="type" disabled value="{{ $loan->type }}" class="block rounded mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full">
