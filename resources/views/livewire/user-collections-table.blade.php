    ...
    <div class="w-4/5 mx-auto my-3">
        <div class="action flex w-full justify-start">
            <div class="relative w-3/5 xl:w-2/5 lg:2/5  text-gray-600 focus-within:text-gray-400 ">
                ...
                <input type="search" name="q" class="py-2 w-full text-sm text-gray-900 font-medium bg-gray-100 rounded-md pl-10 focus:outline-none focus:bg-white focus:text-gray-900" placeholder="Search..." autocomplete="off" wire:model="search">
            </div>
            <label class="block text-left w-max ml-2 " style="max-width: 800px;" wire:model="limitPerPage">
                <select class="py-2 w-full text-sm text-white bg-gray-100 text-gray-900 rounded-md pl-10 focus:outline-none focus:bg-white focus:text-gray-900 font-medium">
