...
@section('content')
    <div class="xl:container w-4/5 mx-auto my-3">
        {{-- {{ $message->homeroom_message->message }} --}}
        <div class="grid grid-cols-12 gap-4">
            <div class="xl:col-span-4 lg:col-span-4 sm:col-span-12 md:col-span-12 col-span-12">
                <div class="block bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" style="width: 100%;">
                        <img src="/storage/{{ $message->homeroom_message->loan_report->book->image }}" alt="" style="width: 100%;" class="rounded">
                </div>
            </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    ...
                                                    <td class="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        {{$message->homeroom_message->loan_report->book->title}}
                                                    </td>
                                                </tr>
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    ...
                                                    <td class="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        {{$message->homeroom_message->status}}
                                                    </td>
                                                </tr>
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    ...
                                                    <td class="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        {{$message->homeroom_message->loan_report->status}}
                                                    </td>
                                                </tr>
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    ...
                                                    <td class="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        {{$message->homeroom_message->loan_report->forfeit}}
                                                    </td>
                                                </tr>
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                ...
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    ...
                                                    <td class="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                       {{ $message->total_kas -  $message->homeroom_message->loan_report->forfeit}}
                                                    </td>
                                                </tr>
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    ...
                                                    <td class="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        {{ \Carbon\Carbon::parse($message->homeroom_message->loan_report->loan_date)->format('d F Y') }}
                                                    </td>
                                                </tr>
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    ...
                                                    <td class="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        {{ \Carbon\Carbon::parse($message->homeroom_message->loan_report->return_date)->format('d F Y') }}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    ...
                                                    <td class="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        {{$message->homeroom_message->loan_report->book->admin->name}}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
