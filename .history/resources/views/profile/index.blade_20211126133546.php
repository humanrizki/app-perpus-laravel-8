    ...
    <div class="container p-3 my-3 d-flex flex-wrap">
        ...
        <div class="profile-info ms-5" >
            <h1 class="position-relative">{{ $user->name }} 
                @if ($user->is_member == 0)
                <span class="badge bg-secondary p-2 fs-6 position-absolute top-0 start-100 ms-1"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Upgrade to Member
                  </button></span>
                @else
