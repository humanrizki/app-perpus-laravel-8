          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item nav-link dropdown-toggle" href="#" id="navbarDropdownSubMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Klik lagi</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdownSubMenuLink">
                  <a href="dropdown-item" href="#"></a>
                </div>
              </div>
            </li>
          </ul>
