          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="nav-link dropdown-item dropdown-toggle nav-link dropdown-toggle" href="#" id="navbarDropdownSubMenuLink" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Klik lagi</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdownSubMenuLink">
                  <a href="dropdown-item" href="#">Makan bang</a>
                </div>
              </div>
            </li>
          </ul>
